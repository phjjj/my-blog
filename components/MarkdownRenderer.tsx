...
const components: Components = {
  h1: ({ children }) => (
    <h1 className="text-[2em] font-semibold text-muted mt-8 mb-4 leading-tight pb-2 border-b border-border break-keep">
      {children}
    </h1>
  ),
  h2: ({ children }) => (
    <h2 className="text-[1.5em] font-semibold text-muted mt-8 mb-4 leading-[1.3] pb-2 border-b border-border break-keep">
      {children}
    </h2>
  ),
  h3: ({ children }) => (
    <h3 className="text-[1.25em] font-semibold text-muted mt-8 mb-3 leading-[1.35] break-keep">
      {children}
    </h3>
  ),
  h4: ({ children }) => <h4 className="text-[1em] font-semibold text-muted mt-6 mb-3 leading-[1.45] break-keep">{children}</h4>,
